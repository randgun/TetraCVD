...
with open('./text_config.yaml', "r") as f:
...
for k in range(args.n_splits):
    ...
    args.language_backbone.split_path = split_path
    # setting record of experiments
    setting = '{}_{}_{}_fold{}_layers_{}_lr_{}_dim_{}_dropout_{}_aggre_{}'.format(
        args.task,
        args.language_backbone.model_name,
        args.language_backbone.category,
        k+1,
        args.language_backbone.num_layers,
        args.learning_rate[1],
        args.language_backbone.bert_dim,
        args.language_backbone.dropout,
        args.language_backbone.use_aggre,
        )
